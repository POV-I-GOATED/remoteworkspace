package net.mcreator.stellar.block.entity;
...
public class BoxingRingConerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BoxingRingConerTileEntity(BlockPos pos, BlockState state) {
		super(StellarModBlockEntities.BOXING_RING_CONER.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BoxingRingConerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BoxingRingConerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("boxing_ring_coner");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Boxing Ring Coner");
	}
