...
import net.mcreator.stellar.client.model.Modelgo;
...
public class LaserRenderer extends EntityRenderer<LaserEntity> {
	private static final ResourceLocation texture = new ResourceLocation("stellar:textures/entities/laser.png");
	private final Modelgo model;

	public LaserRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelgo(context.bakeLayer(Modelgo.LAYER_LOCATION));
	}
