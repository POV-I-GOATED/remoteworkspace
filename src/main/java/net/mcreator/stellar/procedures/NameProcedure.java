			...
			if (entity.getPersistentData().getDouble("VP") == 1) {
				if (!world.getEntitiesOfClass(Villager.class, AABB.ofSize(new Vec3((entity.getPersistentData().getDouble("LocX")), (entity.getPersistentData().getDouble("LocY")), (entity.getPersistentData().getDouble("LocZ"))), 3, 3, 3), e -> true)
					...
					thisd = ((Entity) world
							...
							}.compareDistOf((entity.getPersistentData().getDouble("LocX")), (entity.getPersistentData().getDouble("LocY")), (entity.getPersistentData().getDouble("LocZ")))).findFirst().orElse(null)).getDisplayName().getString();
				}
				...
				thisd = entity.getDisplayName().getString();
			}
		} else {
			thisd = entity.getDisplayName().getString();
		}
		return "Your/ Your Enity name is is:" + thisd;
	}
}
